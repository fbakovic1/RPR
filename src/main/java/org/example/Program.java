...
public class Program {
    ...
    private static void naSlovo() {
        ...
        String response = imenik.naSlovo(s.toCharArray()[0]);
        System.out.println(response);
    }
    ...
    private static void dajIme() {
        ...
        if (ime == null) {
            System.out.println("Ime nije u imeniku");
        }
        else {
    ...
    private static void popuniPodatke(){
        imenik.dodaj("Amar", new MobilniBroj(62, "531-532"));
        imenik.dodaj("Alek", new FiksniBroj(Grad.TUZLA, "876-552"));
        imenik.dodaj("Farah", new MedunarodniBroj("+49", "876-552"));
        imenik.dodaj("Kerim", new FiksniBroj(Grad.NEUM, "876-552"));
    }
}
